            ...
            (function () {
                ...
                module.exports = Itinerary.extend({
                    ...
                    _updateLines: function (routes) {
                        ...
                        var obj = routes.route.waypoints;

                        // console.log('routes waypoints', obj)

                        var separator = ',';
                        var result = [];
                        $.each(obj, function (index, value) {
                            var latlong = value.latLng;
                            var coordinate = latlong.lat + separator + latlong.lng
                            result.push({
                                lat: latlong.lat,
                                long: latlong.lng,
                                coordinate: coordinate,
                        ...
                        // $('#coordinate').val(result);
                        $('#coordinate').val(JSON.stringify(result));
                    },
                ...
                module.exports = (L.Layer || L.Class).extend({
                    ...
                    options: {
                        ...
                        createMarker: function (i, wp) {
                            console.log('wp.latLng', wp.latLng)
                            var options = {
